...
class Config:
    def __init__(self, dataset, train=True, exp_tag=None):
        ...
        self.snr_loss_T = cfg.get('snr_loss_T', 5.0)   # IMPROVEMENT B
        ...
        index = ('_' + exp_tag) if exp_tag else get_log_dir_index(self.base_dir)
